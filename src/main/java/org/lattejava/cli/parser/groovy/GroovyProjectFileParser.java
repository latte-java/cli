...
/**
 * Parses the project file using a Groovy DSL.
 *
...
public class GroovyProjectFileParser implements ProjectFileParser {
  ...
  public GroovyProjectFileParser(Output output, TargetGraphBuilder targetGraphBuilder) {
    this.output = output;
  ...
  public Project parse(Path buildFile, RuntimeConfiguration runtimeConfiguration) throws ParseException {
    ...
    try (GroovyClassLoader groovyClassLoader = new GroovyClassLoader(ClassLoader.getSystemClassLoader(), compilerConfig)) {
      ...
      throw new ParseException("Unable to parse project file", e);
    }
  }
}
