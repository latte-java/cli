...
public class DefaultPluginLoader implements PluginLoader {
  ...
  public Plugin load(Artifact pluginDependency) {
    ...
    try (JarFile pluginJarFile = new JarFile(pluginJarFilePath.toFile())) {
      ...
      throw new PluginLoadException("Unable to load plugin [" + pluginDependency + "] because the plugin class [" + pluginClassName + "] does not extend org.lattejava.cli.plugin.groovy.Plugin", e);
